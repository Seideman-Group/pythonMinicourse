...
# # Guiding questions:
# # 1. What are the index values the correspond to the wavelength divisions in the spectrum?
...
# # 3. How can you loop through the data to find the lower and upper bound integer numbers automatically?
...
# # FindEnergyBounds returns two numbers, the idexes that include min and max wavelengths
# # for the data set. You might use it something like:
# # UV_lower_i, UV_upper_i=FindEnergyBounds(10, 380, data)
# # print 'UV:', UV_lower_i, UV_upper_i

# #Then you can use those indexes to again with your previous function FindMax() to find the max absorbance in a subset of the spectrum
